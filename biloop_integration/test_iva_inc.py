...
def get_pdf(inv):
    ...
    if data.get('data'):
        ...
        with open("test_iva_inc.pdf", "wb") as f: f.write(pdf_res.content)
        print("Saved pdf to test_iva_inc.pdf.")
...
inv = {
    ...
    "invoice_description": "TESTING VAT INCLUDED",
    "ERP_line": [
        {"company_id": "E67652", "product_id": 1, "real_product_id": "1", "product_name": "Chief of Staff", "units": 1, "price": 12.10, "discount": 0, "vat_type_id": "ORD21"}
    ]
}
get_pdf(inv)
